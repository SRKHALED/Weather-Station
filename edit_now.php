<!DOCTYPE html>
	<?php	
		...
		$stn = $_POST['st'];
		$sql="UPDATE `devices` SET `name`='$name',`model`='$model',`location`='$location',`station_no`='$stn' WHERE `D_id` LIKE '$Did'";
...
<body style="background-image: url(pic/b2.png);">
	<header><br><center> <h1 style="color: ;"><b>আবহাওয়া বার্তা</b></h1></center>
		...
		<?php
		   $conn->close(); 
		   header('refresh:1 ;url=all_device.php');
		?>
</body>
</html>
