<?php
	...
	$Did = $_POST['id'];
	$_SESSION["D_id"] = $Did;
	$sql="SELECT * FROM `devices` WHERE `D_id` LIKE '$Did'";
						...
						<div class="card" style="background:#999999;border-radius: 35px;">
							...
							<div class="row">
								...
								<div class="col-md-10 box">
									<form method="post" action="edit_now.php">
										<div class ="form-group">
											<div class="row" style="color: ; font-weight: bold;">
												<div class="col-md-6 box">
													...
													<div class="input-group">
													<?php
													echo "<input type='text' class='form-control' name='model' value = '".$model."'
													 required style='border-radius: 50px;'/>";
													 ?>
													</div>
												</div>
												<div class="col-md-6 box">
													...
													<div class="input-group">
													<?php
													echo "<input type='text' class='form-control' name='location' value = '".$location."'
													 required style='border-radius: 50px;'/>";
													 ?>
													</div>
													...
													<div class="input-group">
													<?php
													echo "<input type='text' class='form-control' name='st' value = '".$station_no."'
													 required style='border-radius: 50px;'/>";
													 ?>
													</div>
												</div>
											...
											<center><input type="submit" class="btn btn-success" value="UPDATE NOW" style="border-radius: 50px; font-weight: bold; width: 30%;" /></center>
										</div>
									</form>
								</div>
							</div>
